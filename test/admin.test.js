...
const { adminRegister, adminLogIn, adminBanUserStatus, adminRegisterAmbulanceDriver, adminRegisterHospital } = require('../src/services/admin.service');
...
describe('Admin Functionality', () => {
    ...
    describe('Admin service', () => {
        ...
        it('should register a new ambulance driver and create a new driver live location entry', async () => {
            ...
            await adminRegisterAmbulanceDriver(phoneNumber, password, companyName, ambulanceType);
            ...
            const passwordIsValid = await bcrypt.compare(password, registeredDriver.password);
        ...
        it('should register a hospital', async () => {
            ...
            const result = await adminRegisterHospital(phoneNumber, password, longitude, latitude);
            ...
            expect(hosp.location.coordinates).to.deep.equal([Number(longitude), Number(latitude)]);
