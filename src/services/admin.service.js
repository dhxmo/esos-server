...
exports.adminRegisterAmbulanceDriver = async (phoneNumber, password, companyName, ambulanceType) => {
    // register driver
...
exports.adminRegisterHospital = async (phoneNumber, password, longitude, latitude) => {
